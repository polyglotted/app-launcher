...
import io.polyglotted.app.http.impl.PlainJetty;
import io.polyglotted.app.resources.impl.MapValuesProvider;
import org.eclipse.jetty.server.Handler;
import org.eclipse.jetty.server.Request;
import org.eclipse.jetty.server.Server;
import org.eclipse.jetty.server.handler.AbstractHandler;
import org.junit.Test;
import io.polyglotted.app.resources.impl.DefaultPropertiesFactory;
...
public class PlainJettyTest {
    ...
    public void jetty_starts_and_serves_a_page() throws Exception {
        int port = PlainJetty.generatePort();
