package org.polyglotted.webapp.http.impl;
...
import org.polyglotted.webapp.http.Jetty;
import org.polyglotted.webapp.http.JettyFeature;
import org.polyglotted.webapp.http.WebappConfig;
...
public class WebappJetty implements Jetty {
    ...
    public WebappJetty(WebappConfig config) {
        this(config, Collections.<JettyFeature>emptyList());
    }

    public WebappJetty(WebappConfig config, List<JettyFeature> features) {
        this.config = config;
